  ...
  return (
    <aside aria-labelledby="insights-heading" className="rounded-2xl border border-slate-800 bg-slate-900/45 p-5 shadow-xl shadow-slate-950/10 sm:p-6">
      <div className="flex items-start justify-between gap-4 border-b border-slate-800/80 pb-4">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-emerald-400">Inferred design</p>
      ...
      <p className="mt-3 text-center text-[10px] text-slate-600">Example findings for this workspace</p>
    </aside>
  )
}
